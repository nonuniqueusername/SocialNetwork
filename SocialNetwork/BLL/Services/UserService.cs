...
namespace SocialNetwork.BLL.Services
{
    public class UserService
    {
        ...
        {
            var findUserEntity = userRepository.FindByEmail(userAddFriendData.FriendMail);
        ...
        {
            return friendRepository.FindAllByUserId(userId).Select(u=> FindById(u.friend_id));
        }
